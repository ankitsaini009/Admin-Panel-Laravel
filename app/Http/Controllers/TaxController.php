...
class TaxController extends Controller
{
    ...
    {
        $Tax_setting = Tax_setting::orderBy('id', 'desc')->first();
        return view('admin.tax_setting.add', compact('Tax_setting'));
    }
    ...
    public function taxstore(Request $request)
    {
        ...
        if (isset($request->tax_id) && !empty($request->tax_id)) {
            ...
            if ($Tax_setting->save()) {
                ...
                return redirect()->route('tax.index')->with('success', 'Tax Save successfully.');
            } else {
